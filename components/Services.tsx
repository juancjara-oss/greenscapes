...
const services = [
  ...
  {
    id: 'gs-service-fertilization-img',
    slug: 'fertilization-weed-control',
    name: 'Fertilization & Weed Control',
    alt: 'Lawn fertilization and weed control service Roanoke Virginia – Greenscapes VA',
    description: 'Seasonal fertilization programs and targeted weed control treatments that keep your lawn thick, green, and weed-free all year long.',
    image: '/assets/fertilization-weed-control.webp',
  },
  {
    id: 'gs-service-aeration-img',
    slug: 'aeration-overseeding',
    name: 'Aeration & Overseeding',
    alt: 'Lawn aeration and overseeding service Roanoke Virginia – Greenscapes VA',
    description: 'Core aeration and premium overseeding to relieve compaction, thicken your turf, and give your lawn a full, lush appearance.',
    image: '/assets/aeration-overseeding.webp',
  },
  {
    id: 'gs-service-additional-img',
    slug: 'additional-services',
    name: 'Additional Services',
    alt: 'Additional landscaping services Roanoke Virginia – Greenscapes VA',
    description: 'Sod installation, lawn seeding, drainage solutions, and pressure washing — complete outdoor care for your Roanoke Valley property.',
    image: '/assets/additional-services.webp',
  },
]
  ...
  return (
    <section id="services" className="bg-[#050e07] py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16 services-header-fade">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <Link key={service.name} href={`/services/${service.slug}`}>
              <div
                className="group relative overflow-hidden rounded-2xl h-72 cursor-pointer hover:-translate-y-1 transition-transform duration-300 services-card-fade"
