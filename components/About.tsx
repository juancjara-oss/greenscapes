        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {values.map((v) => (
              <div
                key={v.title}
                className="bg-white/5 backdrop-blur-sm border border-[#39ff14]/15 rounded-2xl p-6 hover:border-[#39ff14]/60 hover:bg-white/[0.08] hover:shadow-[0_0_20px_rgba(57,255,20,0.1)] transition-all duration-300"
              >
